...
majors <- c("SiO2","TiO2","Al2O3","Fe2O3T","Fe(II)O","MnO","MgO","CaO"
            ,"Na2O","K2O","P2O5","H2O+","CO2","LOI")
minors <- c("Ag","As","B","Ba","Be","Bi","Br","C(org)","C(tot)","Cd",
            "Ce","Cl","Co","Cr",
            "Cs","Cu","Dy","Er","Eu","F","Ga","Gd","Ge","Hf","Hg","Ho"
            ,"I","In","La","Li",
            "Lu","Mo","Nb","Nd","Ni","Pb","Pd","Pr","Rb","S","Sb","Sc"
            ,"Se","Sm","Sn","Sr",
...
# This relatively low proportion of missing values allow us to replace 
#it by a naive estimate, like 
